...
/**
 *struct passinfo - arguments to pass into a function,
 *for prototypes and pointer struct
 *@arg: str generated from getline arguments
 *@argv: array of str generated from arg
 *@path: a str path for command
 *@fname: filename
 *@environ: modified copy of environ
 *@cmd_buf: pointer to cmd_buf for chaining
 *@argc: argument count
...
/**
 *struct builtin - contains builtin str and func
 *@func: function
 *@type: command flag
 */
